              ...
              <ul className="todo__list">
                <li className="todo__item">
                  ...
                  <label className="todo__title">
                    Convert the declaration new type of data to the tuple and
                    the tructure to the integrity
                  </label>
                </li>
                <li className="todo__item">
                  <input type="checkbox" className="todo__toggle" />
                  ...
                  <label className="todo__title">
                    Redetermine the object postion and reset the coodrinates
                    according the value
                  </label>
                </li>
                <li className="todo__item">
                  ...
                  <label className="todo__title">
                    Recalculate the flux capacitator and reinstate democracy in
